...
//			+ "purge_file(?, (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' end) end), "
			+ "purge_file(?, (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/2' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile-art/2' end), "
...
//			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' end) end), ser.series_image_small), "
			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/2' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile-art/2' end), ser.series_image_small), "			
...
//			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' end) end), ser.series_image_small), "
			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/3' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile-art/3' end), ser.series_image_small), "			
