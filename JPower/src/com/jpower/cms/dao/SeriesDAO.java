...
//			+ "purge_file(?, (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' end) end), "
			+ "purge_file(?, (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/2' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile_art/2' end), "
...
//			+ "purge_file(?, (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' end) end), "
			+ "purge_file(?, (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/3' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile_art/3' end), "
...
//			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' end) end), ser.series_image_small), "
			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/2' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/2' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/2' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile_art/2' end), ser.series_image_small), "			
...
//			+ "cat_ser.category_pk = cat.category_pk and cat.category_pk = lob_cat.category_pk and lob_cat.lob_pk = lob.lob_pk";
			+ "cat_ser.category_pk = cat.category_pk and cat.category_pk = lob_cat.category_pk and lob_cat.lob_pk = lob.lob_pk and (upper(lob.lob_id) <> 'COLLECTION' and upper(lob.lob_id) <> 'TILE-ART')";
...
//			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' end) end), ser.series_image_small), "
			+ "copy_file(?, ?, ser.series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/3' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile_art/3' end), ser.series_image_small), "			
