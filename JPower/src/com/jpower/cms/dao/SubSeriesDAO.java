...
//			+ "copy_file(?, ?, sub_ser.sub_series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' end) end), sub_ser.sub_series_image_small), "
			+ "copy_file(?, ?, sub_ser.sub_series_image_small, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/3' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile_art/3' end), sub_ser.sub_series_image_small), "
...
//			+ "copy_file(?, ?, sub_ser.sub_series_image_large, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' else (case when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' end) end), sub_ser.sub_series_image_large), "
			+ "copy_file(?, ?, sub_ser.sub_series_image_large, ? || (case when upper(lob.sub_lob_id) = 'COMMERCIAL' then 'commercial/3' when upper(lob.sub_lob_id) = 'RESIDENTIAL' then 'residential/3' when upper(lob.sub_lob_id) = 'COLLECTION' then 'collection/3' when upper(lob.sub_lob_id) = 'TILE-ART' then 'tile_art/3' end), sub_ser.sub_series_image_large), "			
